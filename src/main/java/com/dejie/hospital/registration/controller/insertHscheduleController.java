...
@Controller
public class insertHscheduleController {
    @Autowired
...
//    }
    @GetMapping("/insertHschedule/{scid}/{week}/{did}/{time}")
    public String edit(@PathVariable(name = "scid") Integer scid,
        ...
        return "insertHschedule";
    }
    @PostMapping("/insertHschedule")
    public String doEditSchedule(@RequestParam(value = "registerLimited",required = false) Integer registerLimited,
        ...
        return  "redirect:/Hschedulemanage/"+did;
    }
    @GetMapping("/delectHschedule/{scid}/{did}")
