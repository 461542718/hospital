...
@Controller
public class inserthospitalController {
    @Autowired
    ...
    public String uploadHphoto( @RequestParam(value = "Hid",required = false) Integer Hid,
        ...
        return "redirect:/inserthospital/"+Hid;
    }
}
